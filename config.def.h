...
static const char *fonts[]          = { "NotoSansMono:pixelsize=18:antialias=true:autohint=true" };
static const char dmenufont[]       = "NotoSansMono:pixelsize=18:antialias=true:autohint=true";
...
static const Rule rules[] = {
	...
	{ "Firefox",  NULL, "Firefox Preferences",       1 << 1,       1,           -1 },
