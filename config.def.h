...
static const char *fonts[]          = { "Inconsolata:pixelsize=18:antialias=true:autohint=true" };
static const char dmenufont[]       = "Inconsolata:pixelsize=18:antialias=true:autohint=true";
